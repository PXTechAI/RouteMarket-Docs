---
title: 路由与模型
description: 理解 RouteLab 如何从逻辑模型请求走到最终的可用 route。
---

RouteLab 的核心价值不是只做代理转发，而是把“**统一模型名 -> 多来源候选 -> 运行时选路**”这条链路做成平台能力。
...
因为 RouteLab 的目标不是只连接一个上游，而是把这些能力统一起来：
