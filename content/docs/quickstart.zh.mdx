---
title: Quickstart
description: Make your first RouteLab request in a few minutes.
---
...
When you need more control, RouteLab also supports fields like:
...
In RouteLab, `model` usually means a **logical model name**.
