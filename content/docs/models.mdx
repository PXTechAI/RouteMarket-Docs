---
title: Models
description: How RouteLab exposes logical models and how to discover what your key can use.
---

In RouteLab, you usually request a **logical model name**, not a raw upstream provider model identifier.
...
The RouteLab model list is designed to expose more than just a name. Depending on the current implementation and policy, a model entry may include fields like:
...
- **Source / route**: what RouteLab actually selects at runtime
