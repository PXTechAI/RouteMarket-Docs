---
title: RouteLab Docs
description: Public product and developer documentation for RouteLab.
---

RouteLab is an AI gateway and control plane for teams that want one place to manage **model access, routing, usage, and cost visibility**.

## What you can do with RouteLab
...
If you are new to RouteLab, read in this order:
